...
For a full list of all IPvGO methods and their descriptions and documentation, you can use the game's [IPvGO API documentation page](https://github.com/bitburner-official/bitburner-src/blob/stable/markdown/bitburner.go.md).
