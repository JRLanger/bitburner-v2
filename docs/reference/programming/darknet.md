...
For the full NS docs for the api, you can go to the [API documentation page](https://github.com/bitburner-official/bitburner-src/blob/stable/markdown/bitburner.darknet.md).
